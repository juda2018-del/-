...
function logoIcon(){ return `<img class="jazal-mark" src="assets/jazal-mark.svg?v=jazal-fusion-v3" alt="شعار جزل" />`; }
...
function coverSrc(story){ return `assets/covers/${story.id}.svg?v=jazal-fusion-v3`; }
...
function safeCover(story, cls=''){
  if(!story) return `<img class="${cls}" src="assets/jazal-mark.svg?v=jazal-fusion-v3" alt="شعار جزل" />`;
...
function playerView(){
  ...
  const artwork=story?coverSrc(story):'assets/jazal-mark.svg?v=jazal-fusion-v3';
  ...
  return `<section class="player-page"><div class="player-stage ${state.player.playing?'':'paused'}">
    ...
    <div class="player-art"><div class="player-art-ring" style="background:${storyGradient(story)}"><img src="${artwork}" alt="غلاف التشغيل" onerror="this.src='assets/jazal-mark.svg?v=jazal-fusion-v3'" /></div></div>
